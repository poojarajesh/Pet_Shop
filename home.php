 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">Love, Treat, Care your Pet</h1>
            <p class="lead fw-normal text-white-50 mb-0">Looking for your pet's needs? We have got you covered.</p>
            <p class="lead fw-normal text-white-50 mb-0">Shop now with us !!</p>
        </div>
    </div>
</header>
<!-- Section-->
